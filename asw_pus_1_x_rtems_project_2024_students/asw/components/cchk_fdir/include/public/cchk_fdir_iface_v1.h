 ...
 *
 */
class CCHK_FDIR: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMCCHK_FDIRSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMCCHK_FDIRSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy };

	/**
	 * \class CCHK_FDIR::CEDROOMMemory
	...
	//! Constructor
	CCHK_FDIR(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMCCHK_FDIRSignal { EDROOMSignalTimeout,
		...
		friend class CCHK_FDIR;

		//!component reference
		CCHK_FDIR &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (CCHK_FDIR &act );
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (CCHK_FDIR &act );
