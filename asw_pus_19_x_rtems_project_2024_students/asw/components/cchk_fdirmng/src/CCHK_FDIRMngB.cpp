...
// Declara la monitorización de parámetros y la lista de eventos	
PUSService12::DoMonitoring(eventList);
// De todos los eventos solo construye TM de aquellos que estén habilitados
// Bit a 1 en la posicion correspondiente
PUSService5::BuildEventListTMs(eventList, VCurrentTMList);
// Se encolan tantas acciones como sea necesario en función de los eventos
